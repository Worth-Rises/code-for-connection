...
function App() {
    return (<Suspense fallback={<div className="min-h-screen flex items-center justify-center">
      ...
      <Routes>
        ...
        <Route path="/incarcerated" element={<ProtectedRoute allowedRoles={['incarcerated']}>
              <IncarceratedLayout />
            </ProtectedRoute>}>
        ...
        {/* Admin Routes */}
        <Route path="/admin" element={<ProtectedRoute allowedRoles={['facility_admin', 'agency_admin']}>
              <AdminLayout />
            </ProtectedRoute>}>
