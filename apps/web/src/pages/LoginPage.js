      ...
      <div className="w-full max-w-md">
        ...
        <Card padding="lg">
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <Input label="Email" type="email" value={email} onChange={(e) => setEmail(e.target.value)} placeholder="Enter your email" fullWidth required/>

            <Input label="Password" type="password" value={password} onChange={(e) => setPassword(e.target.value)} placeholder="Enter your password" fullWidth required/>
          ...
          <div className="mt-6 pt-6 border-t border-gray-200 text-center space-y-3">
            <Link to="/pin-login" className="block text-sm text-blue-600 hover:underline">
