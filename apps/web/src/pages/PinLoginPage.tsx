          ...
          <div className="grid grid-cols-3 gap-3 mb-6">
            {[1, 2, 3, 4, 5, 6, 7, 8, 9].map((digit) => (
              <button
                ...
                className="h-16 text-2xl font-bold bg-gray-100 hover:bg-gray-200 rounded-lg transition-colors"
              >
                {digit}
              </button>
            ))}
            <button
              onClick={handleClear}
              className="h-16 text-sm font-medium bg-gray-100 hover:bg-gray-200 rounded-lg transition-colors"
            >
              Clear
            </button>
            <button
            ...
            <button
              ...
              className="h-16 text-xl bg-gray-100 hover:bg-gray-200 rounded-lg transition-colors"
            >
              ⌫
            </button>
          </div>
