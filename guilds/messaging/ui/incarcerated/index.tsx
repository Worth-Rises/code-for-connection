  ...
  return (
    <div className="space-y-4">
      ...
      {conversations.length === 0 ? (
        <Card padding="lg">
          <p className="text-center py-8 text-lg text-gray-500">No conversations yet.</p>
        </Card>
      ) : (
        <div className="space-y-2">
          {conversations.map((conv) => (
            <button
              ...
              className="w-full text-left bg-white rounded-lg border border-gray-200 p-4 min-h-16 hover:bg-gray-50 transition-colors"
            >
  ...
  return (
    <div className="flex flex-col h-full min-h-[calc(100vh-8rem)]">
      ...
      <div className="flex-1 overflow-y-auto space-y-3 p-4">
        ...
        {messages.map((msg) => {
          const isSent = msg.senderType === 'incarcerated';
          return (
            <div
              key={msg.id}
            ...
            >
              ...
              >
                <p className="text-lg">{msg.body}</p>
      ...
      <div className="border-t border-gray-200 p-4">
        <div className="flex gap-3">
          <textarea
            ...
            className="flex-1 rounded-lg border border-gray-300 p-3 text-lg resize-none focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500"
            rows={2}
            onKeyDown={(e) => {
